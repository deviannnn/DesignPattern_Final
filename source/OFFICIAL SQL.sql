...
GO
INSERT INTO [PRODUCT] ([CODE], [NAME], [COST], [PRICE], [DISCOUNT], [CATEGORY_ID])
VALUES
('0020888', N'Áo Thun Cổ Trụ', 240, 257, 0, 1),
('0020744', N'Áo Thun 3 Lỗ', 240, 257, 0, 1),
('0020560', N'Áo Khoác Bomber', 240, 257, 0, 1),
('0020904', N'Áo Khoác Hoodie', 240, 257, 0, 1),
('0018246', N'Áo Sơ Mi Tay Dài', 240, 257, 0, 1),
('0019773', N'Quần Tây', 240, 257, 0, 1),
('0021624', N'Quần Jean', 240, 257, 0, 1),
('0021365', N'Quần Short', 240, 257, 0, 1),
('0020840', N'Nón Bucket', 240, 257, 0, 1),
('0020082', N'Nón Lưỡi Trai', 240, 257, 0, 1),
('0015529', N'Vớ Lười', 240, 257, 0, 1),
('0015530', N'Vỡ cổ thấp', 240, 257, 0, 1),
('0019857', N'Dây Nịt Da', 240, 257, 0, 1),
('0018923', N'Ví Da', 240, 257, 0, 1),
('0021545', N'Quần Lót', 240, 257, 0, 1),
('0021530', N'Balo', 240, 257, 0, 1),
('0021320', N'Túi Đeo', 240, 257, 0, 1),
('0020873', N'Giày Tây Da', 240, 257, 0, 1),
('0021265', N'Giày Sandal', 240, 257, 0, 1)
...
(
	...
	[DISCOUNT_VOUCHER] INT NOT NULL,
	[TOTAL_DISCOUNT] INT NOT NULL,
	[RECEIVE] INT NOT NULL,
	[NEXT_DISCOUNT_VOUCHER] INT NOT NULL,
	[MIN_AMOUNT_REQUIRED] INT NOT NULL,
